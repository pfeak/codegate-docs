...
description: "Configure Windsurf to write and maintain CodeGate docs (contributor guide)"
icon: "water"
---

This page is for **doc contributors**: configure Windsurf's Cascade AI to write and maintain CodeGate documentation on Mintlify. The following explains how to set up Windsurf for the Mintlify documentation workflow.
