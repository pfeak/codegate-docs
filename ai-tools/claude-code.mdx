...
description: "配置 Claude Code 以编写和维护 CodeGate 文档（贡献者指南）"
icon: "asterisk"
---

本文面向**文档贡献者**：Claude Code 是 Anthropic 官方 CLI 工具。本指南帮助你配置 Claude Code 来编写和维护本站在 Mintlify 上的 CodeGate 文档。
